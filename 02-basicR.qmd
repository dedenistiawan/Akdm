...
Untuk memulai menggunakan R, langkah pertama adalah
...
Setelah R terinstal, unduh RStudio, sebuah Integrated
Development Environment (IDE) untuk R, dari
...
R. Dibandingkan dengan antarmuka dasar R,
...
-   **Console**: Tempat menjalankan perintah R secara
    langsung.
...
R, langkah-langkahnya adalah sebagai berikut:
...
R menyediakan berbagai jenis struktur data untuk mengelola
dan memanipulasi data dalam berbagai bentuk. Pemahaman tentang struktur
data di R sangat penting karena memungkinkan kita untuk
menyimpan dan bekerja dengan data yang lebih kompleks. Beberapa struktur
data dasar yang tersedia di R meliputi vektor, matriks,
data frame, dan list.
